...
public class SandMaterial extends BlockMaterial {


    public SandMaterial(String namespace, String name, MapColor mapColor, int index) {
    ...
    private static Map<MaterialModule, List<BlockFactory<SandMaterial>>> factories = new HashMap<>();
    public static void addBlockType(MaterialModule module, String blockName, BlockConsumer<SandMaterial> consumer) {
