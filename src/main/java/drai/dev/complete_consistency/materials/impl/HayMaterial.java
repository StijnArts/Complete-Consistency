...
public class HayMaterial extends BlockMaterial {


    public HayMaterial(String namespace, String name, MapColor mapColor, int index) {
    ...
    private static Map<MaterialModule, List<BlockFactory<HayMaterial>>> factories = new HashMap<>();
    public static void addBlockType(MaterialModule module, String blockName, BlockConsumer<HayMaterial> consumer) {
