...
public class TerracottaMaterial extends BlockMaterial {


    public TerracottaMaterial(String namespace, String name, MapColor mapColor, int index) {
    ...
    private static Map<MaterialModule, List<BlockFactory<TerracottaMaterial>>> factories = new HashMap<>();
    public static void addBlockType(MaterialModule module, String blockName, BlockConsumer<TerracottaMaterial> consumer) {
