...
public class GlassMaterial extends BlockMaterial {


    public GlassMaterial(String namespace, String name, MapColor mapColor, int index) {
    ...
    private static Map<MaterialModule, List<BlockFactory<GlassMaterial>>> factories = new HashMap<>();
    public static void addBlockType(MaterialModule module, String blockName, BlockConsumer<GlassMaterial> consumer) {
