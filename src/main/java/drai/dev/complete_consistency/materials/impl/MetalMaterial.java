...
public class MetalMaterial extends BlockMaterial {
    ...
    public MetalMaterial(String namespace, String name, MapColor mapColor, int index) {
    ...
    private static Map<MaterialModule, List<BlockFactory<MetalMaterial>>> factories = new HashMap<>();
    public static void addBlockType(MaterialModule module, String blockName, BlockConsumer<MetalMaterial> consumer) {
