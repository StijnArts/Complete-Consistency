...
public class BaseChestBlockEntityRenderer implements BlockEntityRenderer<BaseChestBlockEntity> {
    ...
    public static void registerRenderLayer(Block block) {
        ...
        LAYERS.put(
                block,
                new RenderType[]{
                        RenderType.entityCutout(new ResourceLocation(modId, "textures/block/chest/" + path + ".png")),
                        RenderType.entityCutout(new ResourceLocation(
                                modId,
                                "textures/block/chest/" + path + "_left.png"
                        )),
                        RenderType.entityCutout(new ResourceLocation(
                                modId,
                                "textures/block/chest/" + path + "_right.png"
                        ))
                }
        );
    }
